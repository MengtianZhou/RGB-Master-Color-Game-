...
<div data-role="page">
  <div data-role="header" data-position="fixed">
  	<a href="<?php echo base_url();?>index.php/account/show" class="ui-btn ui-corner-all">account</a>
  	<h1>Photo&nbsp;<img src='<?php echo base_url();?>img/website/003.png' style='width:25px;height:20px'>&nbsp;Shop</h1>
  	<a href="<?php echo base_url();?>index.php/logout" class="ui-btn ui-corner-all">log out</a>
